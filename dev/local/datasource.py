...
__all__ = ['data_paths', 'csv_split_paths', 'tfm_image_pt', 'tfm_brain_mask_pt', 'tfm_skull_stripped_image_pt',
           'tfm_ventricles_mask_pt', 'unsqz', 'create_mr_ct_dsource', 'get_notl_brain_mr_dsource',
           'get_notl_brain_ct_dsource', 'get_notl_ventricle_mr_dsource', 'get_notl_ventricle_ct_dsource',
           'datasource_dict', 'atlas_tfm_image_pt', 'atlas_tfm_brain_mask_pt', 'atlas_tfm_skull_stripped_image_pt',
           'atlas_tfm_ventricles_mask_pt', 'create_atlas_dsource', 'get_atlas_brain_mr_dsource',
           'get_atlas_ventricle_mr_dsource']
...
#Cell
get_notl_brain_mr_dsource = partial(create_mr_ct_dsource, data_paths.MR,
                                             csv_split_paths.MR,
                                             tfm_image_pt,
                                             tfm_brain_mask_pt)

get_notl_brain_ct_dsource = partial(create_mr_ct_dsource, data_paths.CT,
                                             csv_split_paths.CT,
                                             tfm_image_pt,
                                             tfm_brain_mask_pt)

get_notl_ventricle_mr_dsource = partial(create_mr_ct_dsource, data_paths.MR,
                                                 csv_split_paths.MR,
                                                 tfm_skull_stripped_image_pt,
                                                 tfm_ventricles_mask_pt)

get_notl_ventricle_ct_dsource = partial(create_mr_ct_dsource, data_paths.CT,
                                                 csv_split_paths.CT,
                                                 tfm_skull_stripped_image_pt,
                                                 tfm_ventricles_mask_pt)
...
#Cell
get_atlas_brain_mr_dsource = partial(create_atlas_dsource, data_paths.ATLAS,
                                                  data_paths.MR,
...
get_atlas_ventricle_mr_dsource = partial(create_atlas_dsource, data_paths.ATLAS,
                                                  data_paths.MR,
                                                  csv_split_paths.ATLAS,
                                                  csv_split_paths.MR,
