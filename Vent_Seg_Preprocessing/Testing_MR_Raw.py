...
if __name__ == '__main__':
    ...
    scans = Categorizer.categorize_files_by_scan("/data/public/Testing_MR_Raw_DICOM_Files")
    ...
    for scan in scans:
        try:
            ...
            path = "/data/public/Segmentation_Dataset/MR_Dataset/test2"
...
np.save("/data/public/Segmentation_Dataset/MR_Dataset/mishaped_Testing_MR.npy",np.array(mishaped))
np.save("/data/public/Segmentation_Dataset/MR_Dataset/errors_Testing_MR.npy", np.array(errors))
